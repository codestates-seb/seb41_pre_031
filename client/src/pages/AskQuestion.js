					...
					<TipContainer>
						<QuestionTip>
							...
							<p className="bodyLine1">
								You’re ready to <a href="https://stackoverflow.com/help/how-to-ask">ask</a> a <a href="https://stackoverflow.com/help/on-topic">programming-related question</a> and
										...
										<ul className="tags">
											{tags.map((el, index) => (
												<li key={index} className="tag">
													<span className="tagContent">{el.tagName}</span>
													<span className="tagRemove" onClick={() => removeTags(index)}>
														&times;
													</span>
												</li>
											))}
									...
									<TagSideBox>
										...
										<div className="sideContainer">
											...
											<div className="description">
												...
												<p className="line2">
													Tag things in more than one way so people can find them more easily. Add tags for product lines, projects, teams, and the specific technologies or
													languages used.
												</p>
