...
const LogoTalentMain = () => {
	return (
		<LogoSvg aria-hidden="true" viewBox="0 0 115 30">
			<path d="M21 27v-8h3v11H0V19h3v8h18Z" className="path1"></path>
			<path
				...
				className="path2"
			></path>
			<path d="M38 11h1v13h-1z" className="path3"></path>
			<path
