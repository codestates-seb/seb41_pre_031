...
const IconTagSignUp = () => {
	return (
		<IconSvg>
			...
			<path className="path2" d="M13 0a2 2 0 00-1.4.6l-10 10a2 2 0 000 2.8c.1-.2.3-.6.6-.8l10-10a2 2 0 011.4-.6h9.6a2 2 0 00-2-2H13z"></path>
		</IconSvg>
	);
};
export default IconTagSignUp;
