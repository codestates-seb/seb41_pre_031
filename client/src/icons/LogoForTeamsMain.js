...
const LogoForTeamsMain = () => {
	return (
		<LogoSvg aria-hidden="true" viewBox="0 0 185 37">
			<path d="M26 33v-9h4v13H0V24h4v9h22Z" className="path1"></path>
			<path
			...
			></path>
			<path d="M47 13h1v17h-1z" className="path4"></path>
		</LogoSvg>
	);
};
export default LogoForTeamsMain;
